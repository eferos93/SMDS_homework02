...
#sample_var_biased<-function(n){
#  return ((1/(length(n)))*(sum(((n-mean(n))^2))))
#}
...
#samples_stat[3,]<-apply(samples,2,sample_var_biased)
...
**Forse istogrmma per discrete no, ma usare plot = ('h')??**
```{r}
